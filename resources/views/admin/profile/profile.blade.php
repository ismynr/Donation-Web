                    ...
                    <div class="card-body">
                        ...
                        <form class="form-valide" action="{{ route('admin.profile.update', Auth::user()->id) }}" method="post">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Enter a nama.." value="{{ $profile->name }}">
                                </div>
                            </div>
                            <div class="form-group row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="form-valide" action="{{ route('admin.profile.update', Auth::user()->id) }}" method="post">
                            ...
                            <div class="form-group row">
                                <label class="col-lg-4 col-form-label" for="confirm_password">Confirm Password <span class="text-danger">*</span>
                                </label>
                                <div class="col-lg-8">
